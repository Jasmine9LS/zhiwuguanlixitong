<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技术人账号" prop="jishurenzhanghao">
          <el-input v-model="ruleForm.jishurenzhanghao" 
              placeholder="技术人账号" clearable  :readonly="ro.jishurenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技术人账号" prop="jishurenzhanghao">
              <el-input v-model="ruleForm.jishurenzhanghao" 
                placeholder="技术人账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技术人姓名" prop="jishurenxingming">
          <el-input v-model="ruleForm.jishurenxingming" 
              placeholder="技术人姓名" clearable  :readonly="ro.jishurenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技术人姓名" prop="jishurenxingming">
              <el-input v-model="ruleForm.jishurenxingming" 
                placeholder="技术人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	jishurenzhanghao : false,
	jishurenxingming : false,
	mima : false,
	xingbie : false,
	shouji : false,
	youxiang : false,
	touxiang : false,
      ...
      rules: {
          jishurenzhanghao: [
                { required: true, message: '技术人账号不能为空', trigger: 'blur' },
          ],
          jishurenxingming: [
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jishurenzhanghao'){
            this.ruleForm.jishurenzhanghao = obj[o];
	    this.ro.jishurenzhanghao = true;
            continue;
          }
          if(o=='jishurenxingming'){
            this.ruleForm.jishurenxingming = obj[o];
	    this.ro.jishurenxingming = true;
            continue;
          }
          if(o=='mima'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jishurenyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jishurenyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
