<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疾病名称" prop="jibingmingcheng">
          <el-input v-model="ruleForm.jibingmingcheng" 
              placeholder="疾病名称" clearable  :readonly="ro.jibingmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="疾病名称" prop="jibingmingcheng">
              <el-input v-model="ruleForm.jibingmingcheng" 
                placeholder="疾病名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发生时间" prop="fashengshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.fashengshijian" 
                type="datetime"
                placeholder="发生时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fashengshijian" label="发生时间" prop="fashengshijian">
              <el-input v-model="ruleForm.fashengshijian" 
                placeholder="发生时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="疾病症状" prop="jibingzhengzhuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="疾病症状"
                  v-model="ruleForm.jibingzhengzhuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jibingzhengzhuang" label="疾病症状" prop="jibingzhengzhuang">
                    <span>{{ruleForm.jibingzhengzhuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="植物简介" prop="zhiwujianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhiwujianjie" label="植物简介" prop="zhiwujianjie">
                    <span v-html="ruleForm.zhiwujianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jibingzhengzhuang : false,
	fashengshijian : false,
	tupian : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jibingmingcheng = true;
          ...
          if(o=='jibingzhengzhuang'){
            this.ruleForm.jibingzhengzhuang = obj[o];
	    this.ro.jibingzhengzhuang = true;
            continue;
          }
          if(o=='fashengshijian'){
            this.ruleForm.fashengshijian = obj[o];
	    this.ro.fashengshijian = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.zhiwujianjie = this.ruleForm.zhiwujianjie.replace(reg,'../../../springbootx2t46/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhiwujibinganli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhiwujibinganliCrossAddOrUpdateFlag = false;
                  this.parent.search();
